...
public class Point  {
    ...
    public static Point add(Point P1, Point P2) {
        ...
        if((P1 != null && P2 != null && P1.isInfinity() && P2.isInfinity())) {
            return infinityPoint();
        }
        if(P1 == null || P1.isInfinity()) {
            return P2;
        }
        if(P2 == null || P2.isInfinity()) {
            return P1;
        }
    ...
    public static boolean hasSquareY(Point P) {
        return (!P.isInfinity() && isSquare(P.getY()));
    }
    ...
    public static Point pointFromBytes(byte[] b) {
